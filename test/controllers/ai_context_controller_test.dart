  ...
  group('AiContextController Tests', () {
    ...
    group('Context Management', () {
      test('should set context data successfully', () {
        ...
        expect(controller.contextData, containsPair('test_context', contextData));
      });
      ...
      test('should update existing context', () {
        ...
        final updated = controller.updateContext('test_context', {'updated': true});
    ...
    group('Context Filtering', () {
      ...
      test('should get context by type', () {
        final userContexts = controller.getContextByType(AiContextType.userProfile);
      ...
      test('should get context by priority', () {
        final highPriorityContexts = controller.getContextByPriority(AiContextPriority.high);
        
        expect(highPriorityContexts, isNotEmpty);
        expect(highPriorityContexts.first.priority, equals(AiContextPriority.high));
      });
    });
    ...
    group('Value Watching', () {
      ...
      test('should watch Stream and update context', () async {
        ...
        expect(controller.getContext('stream_value')?.data, equals('stream_data'));
