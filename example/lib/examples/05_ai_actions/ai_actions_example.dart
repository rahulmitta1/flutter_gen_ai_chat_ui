...
class _AiActionsExampleState extends State<AiActionsExample> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _controller.addMessage(
        ChatMessage(
          text:
              'Hello! I can help you with calculations, weather information, and unit conversions. Try asking me things like:\n\n'
              '• "Calculate 15 + 27"\n'
    ...
    if (_shouldCalculate(lowerMessage)) {
      ...
      Timer(const Duration(milliseconds: 800), () {
        _controller.addMessage(
          ChatMessage(
            text:
                'I can help you with calculations, weather information, and unit conversions. '
  ...
  void _handleCalculationRequest(String originalMessage, String lowerMessage) {
    Timer(const Duration(milliseconds: 500), () async {
      ...
      if (lowerMessage.contains('sqrt') ||
          lowerMessage.contains('square root')) {
      ...
      if (params != null) {
        String actionName = params.containsKey('function')
            ? 'advanced_math'
            : 'calculate';
        ...
        try {
          ...
          if (result.success) {
            ...
            responseText =
                'Sorry, I encountered an error while calculating: ${result.error}';
          }
          ...
          _controller.updateMessage(
            ChatMessage(
              text:
                  'Sorry, I encountered an unexpected error while calculating.',
              user: _aiUser,
              createdAt: aiMessage.createdAt,
              customProperties: {'id': messageId},
            ),
    ...
    Timer(const Duration(milliseconds: 500), () async {
      ...
      try {
        ...
        if (result.success) {
          ...
          responseText =
              'Here\'s the current weather for ${data['location']}:\n\n'
          ...
          responseText =
              'Sorry, I couldn\'t get the weather information: ${result.error}';
        }
        ...
        _controller.updateMessage(
          ChatMessage(
            text:
                'Sorry, I encountered an error while getting weather information.',
            user: _aiUser,
            createdAt: aiMessage.createdAt,
            customProperties: {'id': messageId},
          ),
  ...
  void _handleConversionRequest(String originalMessage, String lowerMessage) {
    Timer(const Duration(milliseconds: 500), () async {
      ...
      if (lowerMessage.contains('celsius') &&
          lowerMessage.contains('fahrenheit')) {
        fromUnit = 'celsius';
        toUnit = 'fahrenheit';
      } else if (lowerMessage.contains('fahrenheit') &&
          lowerMessage.contains('celsius')) {
        fromUnit = 'fahrenheit';
        toUnit = 'celsius';
      } else if (lowerMessage.contains('meters') &&
          lowerMessage.contains('feet')) {
        fromUnit = 'meters';
        toUnit = 'feet';
      } else if (lowerMessage.contains('feet') &&
          lowerMessage.contains('meters')) {
        fromUnit = 'feet';
        toUnit = 'meters';
      }
      ...
      try {
        ...
        if (result.success) {
          ...
          responseText =
              'Sorry, I couldn\'t convert those units: ${result.error}';
        }
                  ...
                  child: AiChatWidget(
                    ...
                    inputOptions: const InputOptions(
                      decoration: InputDecoration(
                        hintText:
                            'Ask me to calculate, get weather, or convert units...',
